...
class User extends Authenticatable implements MustVerifyEmail
{
    ...
    public static function defaultEmail()
    {
        ...
        $defaultTemplate = [
            ...
            'new_performance' => [
                'subject' => 'New Performance',
                'lang' => [
                    'ar' => '<p>Subject :-إدارة الموارد البشرية / الشركة لإرسال أداء جديد</p>
                    <p>مرحبا { performance_name },</p>
                    <p>آمل أن يجد هذا البريد الإلكتروني بك حالا جيدا! تم إرسال نموذج الأداء الخاص بك للموافقة.</p>
                    <p>يرجى النقر على الزر أدناه للموافقة على النموذج.</p>
                    <p>إذا كان لديك أي أسئلة ، فلا تتردد في الاتصال بنا.</p>
                    <p>شكرا لك</p>
                    <p>Regards,</p>
                    <p>إدارة الموارد البشرية ،</p>
                    <p>{ app_name }</p>',
                    'da' => '<p>Emne:-HR-afdeling / Kompagni til at sende ny pr&aelig;station</p>
                    <p>Hej { performance_name },</p>
                    <p>H&aring;ber denne e-mail finder dig godt! Din pr&aelig;stationsformular er sendt til godkendelse.</p>
                    <p>Venligst klik p&aring; knappen nedenfor for at godkende formularen.</p>
                    <p>Hvis du har nogen sp&oslash;rgsm&aring;l, t&oslash;v ikke med at kontakte os.</p>
                    <p>Tak.</p>
                    <p>Med venlig hilsen</p>
                    <p>HR-afdelingen,</p>
                    <p>{ app_name }</p>',
                    'de' => '<p>Betrifft: -Personalabteilung/Firma zum Senden einer neuen Leistung</p>
                    <p ></p>Hi { performance_name },</p>
                    <p>Ich hoffe, dass diese E-Mail Sie gut findet! Ihr Leistungsformular wurde zur Genehmigung gesendet.</p>
                    <p>Bitte klicken Sie auf die Schaltfl&auml;che unten, um das Formular zu genehmigen.</p>
                    <p>Wenn Sie Fragen haben, z&ouml;gern Sie nicht, uns zu kontaktieren.</p>
                    <p>Danke.</p>
                    <p>Betrachtet,</p>
                    <p>Personalabteilung,</p>
                    <p>{ app_name }</p>',
                    'en' => '<p ><b>Subject:-HR department/Company to send new performance</b></p>
                    <p ><b>Hi {performance_name},</b></p>
                    <p >Hope this email finds you well! Your performance form has been sent for approval.</p>
                    <p >Please click the button below to approve the form.</p>
                    <p >Feel free to reach out if you have any questions.</p>
                    <p ><b>Thank you</b></p>
                    <p ><b>Regards,</b></p>
                    <p ><b>HR Department,</b></p>
                    <p ><b>{app_name}</b></p>',
                    'es' => '<p>Asunto: -Departamento de RR.HH./Empresa para enviar nuevo rendimiento</p>
                    <p>Hi {performance_name},</p>
                    <p>&iexcl;Espero que este correo electr&oacute;nico te encuentre bien! Tu formulario de rendimiento ha sido enviado para su aprobaci&oacute;n.</p>
                    <p>Por favor, haga clic en el bot&oacute;n de abajo para aprobar el formulario.</p>
                    <p>Si&eacute;ntase libre de llegar si usted tiene alguna pregunta.</p>
                    <p>&iexcl;Gracias!</p>
                    <p>Considerando,</p>
                    <p>Departamento de Recursos Humanos,</p>
                    <p>{app_name}</p>',
                    'fr' => '<p>Objet: -HR department / Company to send new performance</p>
                    <p>Hi {performance_name},</p>
                    <p>Hope this email vous trouve bien ! Votre formulaire de performance a &eacute;t&eacute; envoy&eacute; pour approbation.</p>
                    <p>Merci de cliquer sur le bouton ci-dessous pour approuver le formulaire.</p>
                    <p>N\'h&eacute;sitez pas &agrave; nous contacter si vous avez des questions.</p>
                    <p>Je vous remercie</p>
                    <p>Regards,</p>
                    <p>D&eacute;partement des RH,</p>
                    <p>{app_name}</p>',
                    'it' => '<p>Oggetto: - Dipartimento HR / Societ&agrave; per inviare nuova prestazione</p>
                    <p>Ciao {performance_name},</p>
                    <p>Spero che questa email ti trovi bene! Il tuo modulo di prestazione &egrave; stato inviato per l\'approvazione.</p>
                    <p>Si prega di fare clic sul pulsante sottostante per approvare il modulo.</p>
                    <p>Sentiti libero di raggiungere se hai domande.</p>
                    <p>Grazie</p>
                    <p>Riguardo,</p>
                    <p>Dipartimento HR,</p>
    ...
    //get user data with designation 
    ...
    {
        return $this->employee->belongsTo(Designation::class, 'designation_id');
    }
