...
class Employee extends Model
{
    ...
    public function getDesignation($id){
        return Designation::where('id', $id)->pluck('name')->first();
    }

    public function leavetypes()
    {
        return $this->hasMany(LeaveType::class,'employee_id');
    }

    public function EmployeeLeaves()
    {
        return $this->belongsTo('App\Models\LeaveType' , 'id', 'employee_id');
    }

    public function empleaves()
    {
        return $this->belongsTo('App\Models\Leave' , 'id' , 'employee_id');
    }
    ...
    public static function getTeamLead($id)
    {
        $employee = Employee::where('id', $id)->first();
        $team_lead = Employee::where('id', $employee->team_lead)->first();
        return $team_lead;
    }
}
