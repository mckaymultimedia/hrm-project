...
use App\Http\Controllers\EmpBirthdayController;
...
use App\Http\Controllers\EmpRemainingLeavesController;
...
use App\Http\Controllers\JobGraphicalDataController;
...
Route::get('send-mail', function () {
    $to = 'saif.ullah@devsspace.com';
    $subject = 'Your Subject';
    $message = 'Hello, this is a simple test email without a template.';
...
Route::get('/performance-review/edit/{edit}', [PerformanceFormController::class, 'review_edit'])->name('Performance.review_edit')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('/performance', [PerformanceFormController::class, 'index'])->name('PerformanceTable')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/get-team-lead/{employeeId}', [PerformanceFormController::class, 'getteamlead'])->name('getteamlead')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/create', [PerformanceFormController::class, 'create'])->name('performance.create')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/oneyearCreate', [PerformanceFormController::class, 'oneyearCreate'])->name('performance.oneyearCreate')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/create/{id}', [PerformanceFormController::class, 'createFromHome'])->name('performance.createHome')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('/performance/store', [PerformanceFormController::class, 'store'])->name('performance.store')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('/performance/yearDataStore', [PerformanceFormController::class, 'yearDataStore'])->name('performance.yearDataStore')->middleware(
    [
        'auth',
        'XSS',
    ]
...
//edit route 
Route::get('/performance/year/edit/{id}', [PerformanceFormController::class, 'Yearedit'])->name('performance.Yearedit')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/year/show/{id}', [PerformanceFormController::class, 'Yearshow'])->name('performance.Yearshow')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('/performance/year/update/{id}', [PerformanceFormController::class, 'Yearupdate'])->name('performance.Yearupdate')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('/performance/show/{id}', [PerformanceFormController::class, 'show'])->name('performance.show')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/edit/{id}', [PerformanceFormController::class, 'edit'])->name('performance.edit')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('/performance/update/{id}', [PerformanceFormController::class, 'update'])->name('performance.update')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::delete('/performance/delete/{id}', [PerformanceFormController::class, 'destroy'])->name('performance.destroy')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/bd', [PerformanceFormController::class, 'bdPerformance'])->name('performance.bd')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('/performance/bdstore', [PerformanceFormController::class, 'bdstore'])->name('performance.bdstore')->middleware(
    [
        'auth',
        'XSS',
    ]
...
//BDedit
Route::get('/performance/bdedit/{id}', [PerformanceFormController::class, 'bdedit'])->name('performance.Bdedit')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('/performance/bdupdate/{id}', [PerformanceFormController::class, 'bdupdate'])->name('performance.Bdupdate')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/bdshow/{id}', [PerformanceFormController::class, 'bdshow'])->name('performance.Bdshow')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/monthly', [PerformanceFormController::class, 'monthlyPerformance'])->name('performance.monthly')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('/performance/monthlyStore', [PerformanceFormController::class, 'monthlyStore'])->name('performance.monthlyStore')->middleware(
    [
        'auth',
        'XSS',
    ]
...
//edit 
Route::get('/performance/monthlyedit/{id}', [PerformanceFormController::class, 'monthlyedit'])->name('performance.monthly.edit')->middleware(
    [
        'auth',
        'XSS',
    ]
...
//update 
Route::post('/performance/monthlyupdate/{id}', [PerformanceFormController::class, 'monthlyupdate'])->name('performance.monthly.update')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('/performance/monthlyshow/{id}', [PerformanceFormController::class, 'monthlyshow'])->name('performance.monthly.show')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('/hrm/leave/create', [LeaveController::class,'LeaveCreate'])->name('CompanyLeaveCreate')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('Company/StoreEmployeeLeave', [LeaveController::class,'storeemployeeLeave'])->name('storeemployeeLeave')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::post('/GetEmployeesId', [LeaveController::class,'EmployeeId'])->name('GetEmployeesId')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::get('Employee/Birthdays', [EmpBirthdayController::class,'birthdays'])->name('birthdays')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('Employee/RemainingLeaves', [EmpRemainingLeavesController::class,'index'])->name('remaining_leaves')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('employee/manage-leaves/{id}', [EmpRemainingLeavesController::class,'manageEmpLeave'])->name('manage-emp-leaves')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::post('employee/manage-leaves', [EmpRemainingLeavesController::class,'addleaves'])->name('employee.leaves.update')->middleware(
    [
        'auth',
        'XSS',
    ]
);
Route::get('Employee/LeaveDetails/{id}', [LeaveController::class,'LeaveDetails'])->name('LeaveDetails')->middleware(
    [
        'auth',
        'XSS',
    ]
...
Route::group(['middleware' => ['verified']], function () {
    ...
    //Route for organization chart
Route::get('orgchart', [orgchartController::class,'index'])->name('orgchart')->middleware(
    [
        'auth',
        'XSS',
    ]
    ...
    Route::post('leaves/jsoncount', [LeaveController::class, 'jsoncount'])->name('leave.jsoncount')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('employee/leaves/hrm', [LeaveController::class, 'HRMleaveStore'])->name('leave.Byhrm')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('leave/jsoncount', [LeaveController::class, 'jsoncount'])->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('indicator', [IndicatorController::class, 'index'])->name('indicator.index')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::get('indicator/create', [IndicatorController::class, 'create'])->name('indicator.create')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('indicator/store', [IndicatorController::class, 'store'])->name('indicator.store')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::get('indicator/edit', [IndicatorController::class, 'edit'])->name('indicator.edit')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('indicator/update', [IndicatorController::class, 'update'])->name('indicator.update')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::delete('indicator/delete/{indicator}', [IndicatorController::class, 'destroy'])->name('indicator.destroy')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::get('indicator/month', [IndicatorController::class, 'month'])->name('indicator.month')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('indicator/month', [IndicatorController::class, 'monthStore'])->name('indicator.month.store')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::get('indicator/month/edit', [IndicatorController::class, 'editmonth'])->name('indicator.month.edit')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('indicator/month/update', [IndicatorController::class, 'monthUpdate'])->name('indicator.month.update')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::get('indicator/year', [IndicatorController::class, 'year'])->name('indicator.year')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('indicator/year', [IndicatorController::class, 'yearStore'])->name('indicator.year.store')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    //edit 
    Route::get('indicator/year/edit', [IndicatorController::class, 'edityear'])->name('indicator.year.edit')->middleware(
        [
            'auth',
            'XSS',
        ]
    );
    Route::post('indicator/year/update', [IndicatorController::class, 'yearUpdate'])->name('indicator.year.update')->middleware(
        [
            'auth',
            'XSS',
        ]
    ...
    Route::post('setting/event', [SettingsController::class, 'event'])->name('event.setting');
    ...
    //job-details.index
    Route::get('job-details', [JobDetailsController::class, 'index'])->name('job-details.index')->middleware(['auth', 'XSS']);
    Route::get('job-details/create', [JobDetailsController::class, 'create'])->name('job-details.create')->middleware(['auth', 'XSS']);
    Route::post('job-details/store', [JobDetailsController::class, 'store'])->name('job-details.store')->middleware(['auth', 'XSS']);
    Route::get('job-details/edit/{id}', [JobDetailsController::class, 'edit'])->name('job-details.edit')->middleware(['auth', 'XSS']);
    Route::post('job-details/update/{id}', [JobDetailsController::class, 'update'])->name('job-details.update')->middleware(['auth', 'XSS']);
    Route::delete('job-details/delete/{id}', [JobDetailsController::class, 'destroy'])->name('job-details.destroy')->middleware(['auth', 'XSS']);

    //job profile
    Route::get('job-profile', [JobProfileController::class, 'index'])->name('job-profile.index')->middleware(['auth', 'XSS']);
    Route::get('job-profile/create', [JobProfileController::class, 'create'])->name('job-profile.create')->middleware(['auth', 'XSS']);
    Route::post('job-profile/store', [JobProfileController::class, 'store'])->name('job-profile.store')->middleware(['auth', 'XSS']);
    Route::get('job-profile/edit/{id}', [JobProfileController::class, 'edit'])->name('job-profile.edit')->middleware(['auth', 'XSS']);
    
    Route::post('job-profile/update/{id}', [JobProfileController::class, 'update'])->name('job-profile.update')->middleware(['auth', 'XSS']);
    Route::delete('job-profile/delete/{id}', [JobProfileController::class, 'destroy'])->name('job-profile.destroy')->middleware(['auth', 'XSS']);
    Route::get('job-graphical', [JobGraphicalDataController::class, 'jobGraphical'])->name('job-profile.graphical')->middleware(['auth', 'XSS']);
    Route::get('bd-job-details', [JobGraphicalDataController::class, 'getJobDetails'])->name('job-details.getJobDetails')->middleware(['auth', 'XSS']);
    Route::get('/performance-reviews', [PerformanceReviewController::class, 'index'])->name('performance-reviews.index')->middleware(['auth', 'XSS']);
    Route::post('/performance-reviews', [PerformanceReviewController::class, 'status'])->name('performance-reviews.status')->middleware(['auth', 'XSS']);
    Route::get('/performance-reviews/team', [PerformanceReviewController::class, 'team'])->name('performance-reviews.team')->middleware(['auth', 'XSS']);
    //notification 
    Route::get('/notification', [PerformanceReviewController::class, 'notification'])->name('performance-reviews.notification')->middleware(['auth', 'XSS']);
});
