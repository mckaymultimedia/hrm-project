                        ...
                        <tbody>
                            @foreach ($archive_application as $application)
                                <tr>
                                    ...
                                    <td>
                                        @php 
                                            $stage =  \App\Models\JobStage::where('id', $application->stage)->first();
                                        @endphp
                                        @if (!empty($stage))
                                            <span class="badge bg-primary p-2 px-3 rounded">{{ $stage->title }}</span>
                                        @else
                                            <span class="badge bg-warning p-2 px-3 rounded">{{ __('Not Found') }}</span>
                                        @endif
                                    </td>
                                    <td>
