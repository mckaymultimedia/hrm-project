                                        ...
                                        <td class="Action">
                                            @if ($employee->is_active == 1)
                                                <span>
                                                    ...
                                                    @endcan
                                                    @if ($employee->pc_date < \Carbon\Carbon::now())
                                                    <div class="action-btn bg-primary ms-2">
                                                        <a href="{{ route('manage-emp-leaves', \Illuminate\Support\Facades\Crypt::encrypt($employee->id)) }}"
                                                            class="mx-3 btn btn-sm  align-items-center"
                                                            data-bs-toggle="tooltip" title=""
                                                            data-bs-original-title="{{ __('Manage Leaves') }}">
