        ...
        <div class="row">
                        ...
                        @if (Auth::user()->type == 'company')
                            ...
                            <a href="#slack-settings" id="slack-tab"
                                class="list-group-item list-group-item-action border-0">{{ __('Slack Settings') }} <div
                                    class="float-end"><i class="ti ti-chevron-right"></i></div></a>
                            <a href="#event-settings" id="event-tab"
                                class="list-group-item list-group-item-action border-0">{{ __('Event Settings') }} <div
                                    class="float-end"><i class="ti ti-chevron-right"></i></div></a>
            ...
            <div class="col-xl-9">
                                        ...
                                        {{-- <div class="col-md-3">
                                            <div class="custom-control custom-switch p-0">
                                                <div class="form-group ml-2 mr-3">
                                                    ...
                                                    <input type="checkbox"
                                                        class="form-check-input gdpr_cookie gdpr_type"
                ...
                @if (Auth::user()->type == 'company')
                    ...
                    <div class="" id="event-settings">
                        <div class="card">
                            <div class="card-header">
                                <h5>{{ __('Evnet Settings') }}</h5>
                                <small
                                    class="text-secondary font-weight-bold">{{ __('Slack Notification Settings') }}</small>
                            </div>
                            {{ Form::open(['route' => 'event.setting', 'id' => 'slack-setting', 'method' => 'post', 'class' => 'd-contents']) }}
                            <div class="card-body">
                                <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 form-group">
                                        {{ Form::label('Event Webhook URL', __('Slack Event Webhook URL'), ['class' => 'col-form-label']) }}
                                        {{ Form::text('event_webhook', isset($settings['event_webhook']) ? $settings['event_webhook'] : '', ['class' => 'form-control w-100', 'placeholder' => __('Enter Slack Webhook URL'), 'required' => 'required']) }}
                                    </div>
                                </div>
                            </div>
                            <div class="card-footer text-end">
