                            ...
                            <div class="card-header card-body">
                                <div class="row text-xs">
                                    ...
                                    @elseif($emailTemplate->slug == 'new_employee')
                                        ...
                                        @elseif($emailTemplate->slug == 'new_performance')
                                        <div class="row">
                                            {{-- <h6 class="font-weight-bold pb-3">{{__('Performance Create')}}</h6> --}}
                                            <p class="col-4">{{ __('App Name') }} : <span
                                                class="pull-end text-primary">{app_name}</span></p>
                                            <p class="col-4">{{ __('Company Name') }} : <span
                                                class="pull-right text-primary">{company_name}</span></p>
                                            ...
                                            <p class="col-4">{{ __('Employee Name') }} : <span
                                                class="pull-right text-primary">{employee_name}</span></p>
                                                <p class="col-4">{{ __('Department') }} : <span
                                                        class="pull-right text-primary">{department}</span></p>
                                                <p class="col-4">{{ __('Designation') }} : <span
                                                        class="pull-right text-primary">{designation}</span></p>
                                                <p class="col-4">{{ __('Duration') }} : <span
                                                        class="pull-right text-primary">{form_name}</span></p>
                                        </div>
