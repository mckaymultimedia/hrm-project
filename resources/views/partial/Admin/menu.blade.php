...
<div class="navbar-wrapper">
    ...
    <div class="navbar-content">
        <ul class="dash-navbar">
            ...
            <li
                class="dash-item {{ Request::segment(1) == null || Request::segment(1) == 'report' ? ' active dash-trigger' : '' }}">
                <a class="dash-link" href="{{ route('orgchart') }}"><span class="dash-micon"><i
                            class="ti ti-receipt"></i></span>{{ __('Organization Chart') }}</a>
            </li>
            <li class="dash-item">
                <a href="{{ route('birthdays') }}" class="dash-link"><span class="dash-micon"><i style="font-size:24px"
                            class="fa">&#xf1fd;</i></span><span
                        class="dash-mtext">{{ __('Employee Birthdays') }}</span></a>
            </li>
            @if (!Auth::user()->employee)
                <li class="dash-item">
                    <a href="{{ route('remaining_leaves') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-pray"></i></span><span
                            class="dash-mtext">{{ __('Remaining Leaves') }}</span></a>
                </li>
            @endif
            ...
            @if (Gate::check('Manage Employee'))
                @if (\Auth::user()->type == 'employee')
                    ...
                    <li class="dash-item">
                        <a class="dash-link" href="{{ route('PerformanceTable') }}"><span class="dash-micon"><i
                                    class="ti ti-clipboard"></i></span>{{ __('Performance') }}</a>
                    </li>
                @else
                    <li class="dash-item {{ Request::segment(1) == 'employee' ? 'active' : '' }}">
            ...
            @if (Gate::check('Manage Indicator') ||
                    ...
                    Gate::check('Manage Performance Form'))
                <li class="dash-item dash-hasmenu">
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                    ...
                    <ul class="dash-submenu">
                        ...
                        @if (Auth::user()->type() == 'hr' || Auth::user()->type() == 'company')
                            <li class="dash-item">
                                <a class="dash-link"
                                    href="{{ route('PerformanceTable') }}">{{ __('Performance Form') }}</a>
                            </li>
                        @endif
            ...
            @if (Gate::check('Manage Awards') ||
                ...
                <li
                    ...
                    <a href="#!" class="dash-link"><span class="dash-micon"><i
                        ...
                        @else
                            <span class="dash-mtext">{{ __('Operations') }}</span>
            ...
            $department = \App\Models\Employee::where('user_id', $login_User->id)->first();

            
            $isShow = false;
            if($login_User->type == 'employee'){
        ...
        @endphp
                @if($isShow)
                    <li class="dash-item {{ Request::segment(1) == 'job-profile' ? 'active' : '' }}">
                        <a href="{{ route('job-profile.index') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-briefcase"></i></span><span
                                class="dash-mtext">{{ __('Job Profile') }}</span></a>
                    </li>
                    <li class="dash-item {{ Request::segment(1) == 'job-details' ? 'active' : '' }}">
                        <a href="{{ route('job-details.index') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-briefcase"></i></span><span
                                class="dash-mtext">{{ __('Job Details') }}</span></a>
                    </li>
                    <li class="dash-item {{ Request::segment(1) == 'job-graphical-data' ? 'active' : '' }}">
                        <a href="{{ route('job-profile.graphical') }}" class="dash-link"><span class="dash-micon"><i
                                    class="ti ti-briefcase">
                                </i></span><span class="dash-mtext">{{ __('Job graphical data') }}</span></a>
                    </li>
                @endif
            ...
            {{-- @if (\Auth::user()->type != 'employee') --}}
                <li class="dash-item {{ Request::segment(1) == 'notification' ? 'active' : '' }}">
                    <a href="{{ route('performance-reviews.notification') }}" class="dash-link"><span class="dash-micon"><i
                                class="ti ti-briefcase">
                            </i></span><span class="dash-mtext">{{ __('Notifications') }}</span></a>
                </li>
            {{-- @endif --}}
