    ...
    <div class="row">
        ...
        <div class="form-group">
            ...
            <select name="type" class="form-control  select2" id="type">
                <option value="maintenance">{{ __('Equipment Maintenance') }}</option>
                <option value="new_equipment">{{ __('New Equipment Request') }}</option>
                <option value="overtime">{{ __('Overtime Request') }}</option>
                <option value="work_from_home">{{ __('WFH Request') }}</option>
