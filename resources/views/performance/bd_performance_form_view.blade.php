            ...
            <div class="col-md-12">
                ...
                <div class="form-group row">
                    <div class=" col-md-6 designation_div">
                        ...
                        <select class="form-control " name="employee_id" id="" onchange="getTeamLead(this.value)"
                        placeholder="Select employee" required disabled>
                        <option value="" >Select employee</option>
                        @foreach ($employees as $employee)
                            <option value="{{ $employee->id }}" {{ $performance_form->employee_id == $employee->id ? 'selected' : 'disabled' }}>
                                {{ $employee->name }}
                            </option>
                        @endforeach
                    </select>
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="team_lead" name="team_lead" required  value="{{isset($meta['team_lead']) ? $meta['team_lead'] : ''}}" readonly>
                    </div>
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="" class="form-control" name="department" required value="{{ isset($meta['department']) ? $meta['department'] : '' }}" readonly>
                    </div>
                        ...
                        <div class="d-flex">
                            @foreach($subcategories as $subcategory => $description)
                                ...
                                <div class="revenue_growth">
                                    <input type="radio" name="{{ $cleaned_category }}" value="{{ $subcategory }}" {{ isset($meta[$cleaned_category]) && $meta[$cleaned_category] == $subcategory ? 'checked' : 'disabled' }} />
...
<script>
    function getTeamLead(selectedEmployeeId) {
        ...
        fetch(`/get-team-lead/${selectedEmployeeId}`)
            ...
            .then(data => {
                if (data.team_lead) {
                    console.log("team lead is ", data.team_lead)
...
<script>
    ...
    function generatePDF() {
        ...
        const combinedHTML = element1.innerHTML ;
