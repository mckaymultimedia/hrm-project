                            ...
                            <div class="d-flex">
                                    <div class="revenue_growth">
                                        @if($category->very_dissatisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="very_dissatisfactory" @if($meta[$category->title] == 'very_dissatisfactory') checked @endif>
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->dissatisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="dissatisfactory" @if($meta[$category->title] == 'dissatisfactory') checked @endif>
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->neutral == 1)
                                            <input type="radio" name="{{$category->title}}" value="neutral" @if($meta[$category->title] == 'neutral') checked @endif>
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->satisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="satisfactory" @if($meta[$category->title] == 'satisfactory') checked @endif>
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->very_satisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="very_satisfactory" @if($meta[$category->title] == 'very_satisfactory') checked @endif>
