<form method="post" action="{{ route('performance.Yearupdate', $performance_form->id) }}" enctype="multipart/form-data">
    @csrf
                    ...
                    <div id="tab1" class="tab row">
                        ...
                        <div class="col-md-6">
                            <label for="department" class="col-form-label">Department:<span
                                    style="color:red">*</span></label>
                            <input type="" class="form-control" name="department" required
                                value="{{ $meta['department'] }}" id="department">
                        </div>
                    <div>
                        ...
                        <table style="width:100%" class="year_form">
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="existing_systems_comment" placeholder="" id="floatingTextarea2" style="">{{ $meta['existing_systems_comment'] }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="professional_environment_comment" placeholder="" id="floatingTextarea2">{{ $meta['professional_environment_comment'] }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="project_lead_comment" placeholder="" id="floatingTextarea2" style="">{{ $meta['project_lead_comment'] }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="new_systems_comment" placeholder="" id="floatingTextarea2" style="">{{ $meta['new_systems_comment'] }}</textarea>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="assigned_tasks_comment" placeholder="" id="floatingTextarea2" style="">{{ $meta['assigned_tasks_comment'] }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="late_sitting_comment" placeholder="" id="floatingTextarea2" style="">{{ $meta['late_sitting_comment'] }}</textarea>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td>
                                    <textarea class="form-control" name="timely_delivery_comment" placeholder="" id="floatingTextarea2" style="">{{ $meta['timely_delivery_comment'] }}</textarea>
                                </td>
                            </tr>
                            <tr>
                                        ...
                                        <div class="d-flex ">
                                            <div style="border: 1px solid gray;">
                                                ...
                                                <input type="radio" name="{{ $indicator->title }}"
                                                    ...
                                                    {{ isset($meta[$indicator->title]) && $meta[$indicator->title] == 'Unsatisfactory' ? 'checked' : '' }}>
                                            ...
                                            <div style="border: 1px solid gray;">
                                                ...
                                                <input type="radio" name="{{ $indicator->title }}"
                                                    ...
                                                    {{ isset($meta[$indicator->title]) && $meta[$indicator->title] == 'Less Satisfactory' ? 'checked' : '' }}>
                                                <p style="font-size: 12px;">
                                            ...
                                            <div style="border: 1px solid gray;">
                                                ...
                                                <input type="radio" name="{{ $indicator->title }}"
                                                    ...
                                                    {{ isset($meta[$indicator->title]) && $meta[$indicator->title] == 'Fully Satisfactory' ? 'checked' : '' }}>
                                                <p style="font-size: 12px;">
                                            ...
                                            <div style="border: 1px solid gray;">
                                                ...
                                                <input type="radio" name="{{ $indicator->title }}"
                                                    ...
                                                    {{ isset($meta[$indicator->title]) && $meta[$indicator->title] == 'Excellent' ? 'checked' : '' }}>
                                            ...
                                            <div style="border: 1px solid gray;">
                                                ...
                                                <input type="radio" name="{{ $indicator->title }}"
                                                    ...
                                                    {{ isset($meta[$indicator->title]) && $meta[$indicator->title] == 'Outstanding' ? 'checked' : '' }}>
                        ...
                        <div id="second-tab" style="">
                            <div class="form-group mt-3">
                                <label for="floatingTextarea2">Areas that require development & suggestions to
                                    accomplish:</label>
                                <textarea class="form-control" name="suggestions" placeholder="" id="floatingTextarea2" style="height: 100px">{{ isset($meta['suggestions']) ? $meta['suggestions'] : '' }}</textarea>
                            </div>
                            <div class="form-group">
                                <label for="floatingTextarea2">Comment:</label>
                                <textarea class="form-control" name="comment" placeholder="" id="floatingTextarea2" style="height: 100px">{{ isset($meta['comment']) ? $meta['comment'] : '' }}</textarea>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <label for="date" class="col-form-label">Date:<span
                                            style="color:red">*</span></label>
                                    <input type="date" class="form-control" name="lead_date" value="{{ isset($meta['lead_date']) ? $meta['lead_date'] : '' }}">
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label for="date" class="col-form-label">Date:<span
                                            style="color:red">*</span></label>
                                    <input type="date" class="form-control" name="employe_date" value="{{ isset($meta['employe_date']) ? $meta['employe_date'] : '' }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="date" class="col-form-label">Date:<span
                                            style="color:red">*</span></label>
                                    <input type="date" class="form-control" name="hr_date" value="{{ isset($meta['hr_date']) ? $meta['hr_date'] : '' }}">
                                </div>
                                <div class="col-md-6">
                                ...
                                <div class="col-md-6">
                                    <label for="date" class="col-form-label">Date:<span
                                            style="color:red">*</span></label>
                                    <input type="date" class="form-control" name="ceo_date" value="{{ isset($meta['ceo_date']) ? $meta['ceo_date'] : '' }}">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="modal-footer">
        ...
        <input type="submit" value="{{ __('Update') }}" class="btn btn-primary" style="display: none;">
    </div>
</form>
