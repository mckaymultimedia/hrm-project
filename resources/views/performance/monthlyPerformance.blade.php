<form method="post" action="{{ route('performance.monthlyStore') }}" enctype="multipart/form-data">
    @csrf
                ...
                <div class="form-group row">
                    <div class=" col-md-6 designation_div">
                        ...
                        <select class="form-control  designation_id select2" name="employee_id" id="choices-multiple"
                            onchange="getTeamLead(this.value)" placeholder="Select employee" required>
                            ...
                            <div class="d-flex">
                                    <div class="revenue_growth">
                                        @if($category->very_dissatisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="very_dissatisfactory">
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->dissatisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="dissatisfactory">
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->neutral == 1)
                                            <input type="radio" name="{{$category->title}}" value="neutral">
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->satisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="satisfactory">
                                    ...
                                    <div class="revenue_growth">
                                        @if($category->very_satisfactory == 1)
                                            <input type="radio" name="{{$category->title}}" value="very_satisfactory">
